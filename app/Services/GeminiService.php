...
class GeminiService
{
    ...
    public function __construct()
    {
        ...
        $this->url = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent';
    }
    ...
    {
        $prompt = "tenho o seguinte texto e pretendo transformar em linguagem de marcação (formatação html) com bolds e titulos, etc para gravar como artigo na base de dados do meu blog, por favor faça isso e envie os dados no seguinte formato JSON: {description: DESCRICÃO_EM_HYPERTEXTO}: " . $descricao;
